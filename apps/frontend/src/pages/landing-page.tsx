  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Organize your life with Protask - a powerful, intuitive task management
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-xl mx-auto">
            Join thousands of users who have transformed their productivity with Protask.
          </p>
          <Link to="/auth/sign-up">
            <Button size="lg" className="text-lg px-8 py-3">
      ...
      <footer className="border-t py-8 px-4">
        <div className="container mx-auto text-center">
          <p className="text-muted-foreground">
            © 2025 Protask. Built with care for productivity enthusiasts.
          </p>
        </div>
      </footer>
    </div>
