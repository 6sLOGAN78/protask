...
import (
	...
	"github.com/6sLOGAN78/go-protask/internal/cron"
)

func main() {
	rootCmd := &cobra.Command{
		Use:   "cron",
		Short: "Protask Cron Job Runner",
		Long:  "Protask Cron Job Runner - Execute scheduled jobs for the Protask task management system",
	}
